...
//variable - username , value = Vengadesh , datatype - string
let userName = "Vengadesh"; // string
let userAge = 25; // number
let isMentor = true; // boolean
let userObj = { name: "", age: 25, isStudent: true }; // object
let userArr = ["Vengadesh", 25, true]; // array [object]
